    ...
    return (
        <section id='contact' className='pb-10 mt-10'>
            <div className='container'>
                <h2 className=' text-headingColor text-[2rem] font-[700]'>
                    Get in touch
                </h2>
                    ...
                    <div className='w-full mt-8 md:mt-0 md:w-2/3 sm:h-[450px] lg:flex items-center rounded-[10px] px-2 lg:px-8 py-8 bg-gradient-to-r from-purple-500 to-red-300'>
                        <form className='w-2/3 '>
                            ...
                            <button
                                ...
                                className='w-2/3 mx-16 p-3 focus:outline-none rounded-[5px] bg-primaryColor text-white hover:bg-smallTextColor text-center ease-linear duration-150'
                            >
                                Send Message{' '}
                            </button>
                        </form>
